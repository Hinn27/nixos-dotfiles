...
, ...
  ...
  programs.spicetify =
    ...
    in
    {
      ...
      colorScheme = "custom";
      customColorScheme = import ./spicetify-colors.nix;
    };
    ...
    "matugen/templates/spicetify-colors.nix".text = ''
      {
        ...
        selected-row = "{{colors.secondary_container.default.hex_stripped}}";
        ...
        tab-active = "{{colors.secondary_container.default.hex_stripped}}";
